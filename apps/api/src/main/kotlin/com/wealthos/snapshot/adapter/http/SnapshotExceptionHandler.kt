...
class SnapshotExceptionHandler {
    ...
    fun handle(exception: SnapshotNotFoundException, request: HttpServletRequest) = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, exception.message ?: "Snapshot was not found").apply {
