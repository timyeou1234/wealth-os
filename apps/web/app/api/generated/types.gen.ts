...
export type FxRateSyncRequest = {
    from?: string | null;
    to?: string | null;
};

export type FxRateSyncResponse = {
    provider?: string;
    inserted?: number;
    unchanged?: number;
...
export type FxRateItemResponse = {
...
export type FxRateResponse = {
    ...
    asOf?: string;
    rates?: Array<FxRateItemResponse>;
...
export type SyncFxRatesData = {
    body?: FxRateSyncRequest;
    path?: never;
    query?: never;
    url: '/api/v1/fx-rates/sync';
};

export type SyncFxRatesResponses = {
    /**
     * OK
     */
    200: FxRateSyncResponse;
};

export type SyncFxRatesResponse = SyncFxRatesResponses[keyof SyncFxRatesResponses];
...
export type GetFxRatesResponses = {
    /**
     * OK
     */
    200: FxRateResponse;
...
export type GetFxRatesResponse = GetFxRatesResponses[keyof GetFxRatesResponses];
